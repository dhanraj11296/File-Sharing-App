# Hello team, I used many refernce to built this file sharing app
# I faced difficult in login, instead I used sockets for authentication
# Provided dummy data's from a user to end user view
# We need to open this file path from our system and then a scanner opens to authenticate end user
# Here I have provided the link of QR Scnner URL to show dummy data
# Also verify my video recording regaring the process
